...
export function Cart() {
  // Giả sử cart là một state hoặc một đối tượng được cung cấp từ context hoặc props
  const [cart, setCart] = useState({ totalQuantity: 0 });

  // Preload sheet function placeholder
  const preloadSheet = () => {
